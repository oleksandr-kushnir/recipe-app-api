...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe(self):
        """Test ctreating a recipe."""
        payload = {
            "title": "Sample recipe",
            "time_minutes": 30,
            "price": Decimal("5.99"),
        }
        res = self.client.post(RECIPES_URL, payload)  # /api/recepies/recipe
    ...
    def test_partial_update(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        recipe.refresh_from_db()  # The model gets NOT refreshed by default
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        # set foramt argument because of json
